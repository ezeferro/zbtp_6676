CLASS zcl_insert_data_6676 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_INSERT_DATA_6676 IMPLEMENTATION.
...
*last_changed_at       : abp_lastchange_tstmpl;
 ...
 data: lt_acc_categ type table of ZTB_ACC_CAT_4522,
          lt_catego    type table of ZTB_CATEGO_4522,
          lt_clientes  type table of ZTB_CLNTS_4522,
          lt_clnts_lib type table of ZTB_CLN_LIB_4522,
          lt_libros    type table of ZTB_LIBROS_4522.
...
******** ZTB_ACC_CAT_4522 ********
    ...
    insert ZTB_ACC_CAT_4522 from table @lt_acc_categ.
...
******** ZTB_CATEGO_4522 ********
    ...
    insert ZTB_CATEGO_4522 from table @lt_catego.
...
******** ZTB_CLNTS_4522 ********
    ...
    "Delete possible entries; insert new entries
    delete from ZTB_CLNTS_4522.
    insert ZTB_CLNTS_4522 from table @lt_clientes.
...
******** ZTB_CLN_LIB_4522
    ...
    "Delete possible entries; insert new entries
    delete from ZTB_CLN_LIB_4522.
    insert ZTB_CLN_LIB_4522 from table @lt_clnts_lib.
...
******** ZTB_LIBROS_4522 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ZTB_LIBROS_4522.
    insert ZTB_LIBROS_4522 from table @lt_libros.
